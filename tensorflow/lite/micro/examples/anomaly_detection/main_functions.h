...
#include "tensorflow/lite/micro/examples/anomaly_detection/main_functions.h"

#include "tensorflow/lite/micro/examples/anomaly_detection/detection_responder.h"
#include "tensorflow/lite/micro/examples/anomaly_detection/image_provider.h"
#include "tensorflow/lite/micro/examples/anomaly_detection/model_settings.h"
#include "tensorflow/lite/micro/micro_interpreter.h"
#include "tensorflow/lite/micro/micro_log.h"
#include "tensorflow/lite/micro/micro_mutable_op_resolver.h"
#include "tensorflow/lite/micro/models/ad_data.h"
...
void setup() {
  ...
  model = tflite::GetModel(g_ad_data);
...
void loop() {
  ...
  RespondToDetection(output->data.uint8);
}
