...
#include "tensorflow/lite/micro/examples/mnist_lstm/lstm_model_settings.h"
#include "tensorflow/lite/micro/examples/mnist_lstm/lstm_model.h"
#include "tensorflow/lite/micro/micro_interpreter.h"
#include "tensorflow/lite/micro/micro_log.h"
#include "tensorflow/lite/micro/micro_mutable_op_resolver.h"
#include "tensorflow/lite/micro/examples/mnist_lstm/detection_responder.h"
#include "tensorflow/lite/micro/testing/micro_test.h"
#include "tensorflow/lite/schema/schema_generated.h"
#include "tensorflow/lite/micro/examples/mnist_lstm/dataset.h"
#include <iostream>
#include <fstream>
...
const char *dataset_path = "REV_PARSE_PATH_PLACEHOLDER/microscale/tflite-micro/tensorflow/lite/micro/examples/mnist_lenet/dataset";

TF_LITE_MICRO_TESTS_BEGIN
TF_LITE_MICRO_TEST(TestInvoke) {
  const tflite::Model* model = ::tflite::GetModel(mnist_lstm_tflite);
